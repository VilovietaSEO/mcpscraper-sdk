...
## [Unreleased] — verified against mcp-scraper 0.74.0 / mcp-memory 1.19.1
...
- Added the separately named 56-operation Assistant owner REST contract without replacing the established scraper REST OpenAPI contract.
...
- Regenerated all six unified developer surfaces from the exact 346-tool MCP Scraper source manifest and all direct Memory clients from the exact 121-tool Memory contract.
