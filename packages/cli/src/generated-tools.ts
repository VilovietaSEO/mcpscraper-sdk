    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "proxyMode": {
          ...
          "default": "location",
          "description": "Defaults to location (city/state residential proxy targeting). configured forces the service proxy without city/ZIP targeting; none is local debugging only."
        },
        "proxyZip": {
          "type": "string",
          "pattern": "^\\d{5}$",
          "description": "Optional US ZIP override for residential proxy targeting."
        },
        "debug": {
          "type": "boolean",
          "default": false,
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "proxyMode": {
          ...
          "default": "location",
          "description": "Proxy targeting per city search. Defaults to location (city/ZIP-group residential targeting); configured forces the service proxy; none is local debugging only."
        },
        "proxyZip": {
          "type": "string",
          "pattern": "^\\d{5}$",
  ...
  },
  {
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "quotaPerPeriod": {
          "type": "number",
          "description": "Monthly execution quota. Optional; defaults to 1000, or leaves the existing value unchanged if already set."
        },
        "mcpScraperApiKey": {
          "type": "string",
