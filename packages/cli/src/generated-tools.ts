export const MCP_TOOL_CATALOG = [
        ...
        "person": {
          ...
          "properties": {
            "identityTier": {
              "type": "string",
              "const": "confirmed",
              "description": "Confirmed or candidate identity tier; provider mutations require confirmed."
            },
            "personId": {
              "type": "string",
              "minLength": 1,
            ...
            "deterministicIdentity": {
              ...
              "description": "Verified email, phone, CRM, or customer identity used only for a confirmed person."
            },
            "consentReceiptRef": {
              "type": "string",
              "minLength": 1,
              "maxLength": 240,
              "description": "Opaque consent receipt reference proving the required purpose at execution time."
            }
          },
          "required": [
            "identityTier",
          ...
          "additionalProperties": false,
          "description": "Confirmed person associated with the pipeline event; candidate identity is schema-invalid."
        },
        "event": {
          "type": "object",
          "properties": {
            ...
            "verifiedRevenueMinor": {
              "description": "Verified revenue in integer currency minor units; inferred values are forbidden.",
              "type": "integer",
              "minimum": 0,
        ...
        "plan": {
          ...
          "properties": {
            ...
            "connectionId": {
              ...
              "minLength": 1,
              "maxLength": 240,
              "description": "Existing authorized service-connection reference; never supply credentials or tokens."
            },
            "personObject": {
              "type": "string",
              "minLength": 1,
              "maxLength": 100,
              "description": "Authorized provider object that stores confirmed people."
            },
            "existingMappings": {
              "type": "object",
              "propertyNames": {
              ...
              "description": "Existing writable provider fields already mapped to namespaced X-Ray fields."
            },
            "proposedFields": {
              "maxItems": 50,
              "type": "array",
              "items": {
                ...
                "properties": {
                  "object": {
                    ...
                    "minLength": 1,
                    "maxLength": 100,
                    "description": "Provider object selected for this explicit CRM mapping."
                  },
                  "internalName": {
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 160,
                    "description": "Provider field internal name discovered from the authorized tenant."
                  },
                  "label": {
                    "type": "string",
                    "minLength": 1,
                  ...
                  "writable": {
                    "type": "boolean",
                    "description": "Whether the authorized tenant reports this provider field as writable."
                  },
                  "required": {
              ...
              "description": "Missing namespaced fields proposed by the no-write provisioning plan."
            },
            "fallback": {
              "type": "string",
              "enum": [
              ...
              "description": "Safe provider activity or note fallback selected by the canonical provider contract."
            },
            "permissionRequirements": {
              ...
              "description": "Provider permissions required before approving this exact plan."
            },
            "schemaFingerprint": {
              "type": "string",
              "pattern": "^[a-f0-9]{64}$",
              "description": "Tenant schema fingerprint bound to the tested provisioning receipt."
            },
            "requestFingerprint": {
              "type": "string",
              "pattern": "^[a-f0-9]{64}$",
              "description": "Server-computed immutable request fingerprint used to detect conflicting reuse."
            },
            "createdAt": {
              "type": "string",
              "format": "date-time",
              "pattern": "^(?:(?:\\d\\d[2468][048]|\\d\\d[13579][26]|\\d\\d0[48]|[02468][048]00|[13579][26]00)-02-29|\\d{4}-(?:(?:0[13578]|1[02])-(?:0[1-9]|[12]\\d|3[01])|(?:0[469]|11)-(?:0[1-9]|[12]\\d|30)|(?:02)-(?:0[1-9]|1\\d|2[0-8])))T(?:(?:[01]\\d|2[0-3]):[0-5]\\d(?::[0-5]\\d(?:\\.\\d+)?)?(?:Z))$",
              "description": "ISO 8601 creation time recorded by the server."
            }
          },
          "required": [
            "planId",
          ...
          "additionalProperties": false,
          "description": "Exact durable plan returned by analytics_plan_crm_provisioning; altered plans are rejected."
        },
  ...
  },
  {
    ...
    "inputSchema": {
      ...
      "properties": {
        ...
        "syncId": {
          "type": "string",
          "pattern": "^crmsync_[a-f0-9]{24}$",
          "description": "Durable sync id returned by analytics_start_crm_sync."
        }
      },
      "required": [
        "siteId",
      ...
      "properties": {
        ...
        "mapping": {
          ...
          "properties": {
            ...
            "firstName": {
              "description": "Confirmed contact first name authorized for this CRM operation.",
              "type": "string"
            },
            "lastName": {
              "description": "Confirmed contact last name authorized for this CRM operation.",
              "type": "string"
            },
            "name": {
              "description": "Human-readable name for the record being created or updated.",
        ...
        "mapping": {
          ...
          "properties": {
            ...
            "sourceEventIdField": {
              ...
              "minLength": 1,
              "maxLength": 160,
              "description": "Provider field containing the stable source-event identifier."
            },
            "occurredAtField": {
              "type": "string",
              "minLength": 1,
              "maxLength": 160,
              "description": "Provider field containing the source event occurrence time."
            },
            "personIdField": {
              "description": "Optional provider field containing the confirmed-person association.",
              "type": "string",
              "maxLength": 160
            },
            "dealIdField": {
              "description": "Optional provider field containing the deal association.",
              "type": "string",
              "maxLength": 160
            },
            "stageField": {
              "description": "Optional provider field containing the pipeline stage.",
              "type": "string",
              "maxLength": 160
            },
            "valueField": {
              "description": "Optional provider field containing verified revenue.",
              "type": "string",
              "maxLength": 160
            },
            "currencyField": {
              "description": "Optional provider field containing the ISO currency code.",
              "type": "string",
              "maxLength": 160
            },
            "eventName": {
          ...
          "additionalProperties": false,
          "description": "Typed mapping that passed analytics_test_crm_sync_mapping."
        },
        "backfillFrom": {
      ...
      "properties": {
        ...
        "person": {
          ...
          "properties": {
            ...
            "firstTouch": {
              "description": "Bounded first-touch attribution summary authorized by the selected policy.",
              "type": "string",
              "maxLength": 1000
            },
            "lastNonDirectTouch": {
              "description": "Bounded last non-direct attribution summary authorized by the selected policy.",
              "type": "string",
              "maxLength": 1000
            },
            "convertingTouch": {
              "description": "Bounded converting-touch attribution summary authorized by the selected policy.",
              "type": "string",
              "maxLength": 1000
            },
            "landingPage": {
              "description": "Canonical attributed landing-page URL authorized by the selected policy.",
              "type": "string",
              "maxLength": 2000,
              "format": "uri"
            },
            "conversionPage": {
              "description": "Canonical conversion-page URL authorized by the selected policy.",
              "type": "string",
              "maxLength": 2000,
              "format": "uri"
            },
            "sessionCount": {
              ...
              "minimum": 0,
              "maximum": 9007199254740991,
              "description": "Aggregate confirmed-person session count; no session identifiers are included."
            },
            "eventCount": {
              "type": "integer",
              "minimum": 0,
              "maximum": 9007199254740991,
              "description": "Aggregate confirmed-person event count; no unrestricted event history is included."
            },
            "campaignClickCoverage": {
              "description": "Bounded campaign-click coverage summary; raw click identifiers require their own allowed policy fields.",
              "type": "string",
              "maxLength": 240
            },
            "consentReceiptRef": {
            ...
            "detailedJourneyUrl": {
              ...
              "maxLength": 2000,
              "format": "uri",
              "description": "Authorized first-party URL for the confirmed person journey; it is not a bearer credential."
            }
          },
          "required": [
            "identityTier",
          ...
          "additionalProperties": false,
          "description": "Confirmed-person projection only. Candidate identity and evidence are schema-invalid."
        },
        "mapping": {
        ...
        "receipt": {
          ...
          "properties": {
            "receiptId": {
              ...
              "description": "Durable redacted receipt identifier returned by the provider operation."
            },
            "planId": {
              "type": "string",
              "pattern": "^crmplan_[a-f0-9]{24}$",
            ...
            "createdFields": {
              ...
              "items": {
                ...
                "properties": {
                  ...
                  "providerFieldId": {
                    "description": "Opaque provider field reference returned after field creation.",
                    "type": "string",
                    "minLength": 1,
                    "maxLength": 240
                  }
              ...
              "description": "Exact namespaced provider fields created by the approved provisioning operation."
            },
            "existingMappings": {
              "type": "object",
              "propertyNames": {
            ...
            "cleanup": {
              ...
              "properties": {
                "supported": {
                  "type": "boolean",
                  "description": "Whether the provider supports the described governed operation."
                },
                "instructions": {
                  "type": "string",
                  "maxLength": 1000,
                  "description": "Safe operator-facing recovery or cleanup instructions without credentials or provider bodies."
                }
              },
              "required": [
                "supported",
              ...
              "additionalProperties": false,
              "description": "Bounded cleanup support and instructions for a provisioning test or field creation."
            },
            "planFingerprint": {
              "type": "string",
              "pattern": "^[a-f0-9]{64}$",
              "description": "Server-computed fingerprint binding a provisioning receipt to its approved plan."
            },
            "occurredAt": {
              "type": "string",
              "format": "date-time",
            ...
            "errorCode": {
              "description": "Safe bounded error code; provider messages and record bodies are omitted.",
              "type": "string",
          ...
          "additionalProperties": false,
          "description": "Exact durable approval receipt returned by analytics_approve_crm_provisioning; altered receipts are rejected."
        },
        "idempotencyKey": {
          "type": "string",
          "minLength": 8,
  ...
  },
  {
    ...
    "inputSchema": {
      ...
      "properties": {
        "url": {
          "description": "Public live site to render and compare. Bare domains default to https://.",
          "type": "string",
          "minLength": 1
        },
        "maxPages": {
          "default": 100,
          "description": "Maximum rendered pages to compare; default 100, maximum 500.",
          "type": "integer",
          "minimum": 2,
          "maximum": 500
        },
        "similarityThreshold": {
          "default": 0.9,
          "description": "Minimum raw cosine score retained in the pair table; default 0.90.",
          "type": "number",
          "minimum": 0,
          "maximum": 1
        },
        "similarityMaxPairs": {
          "default": 10000,
          "description": "Maximum scored pairs retained, highest first; default 10,000.",
          "type": "integer",
          "minimum": 1,
          "maximum": 50000
        },
        "idempotencyKey": {
          ...
          "minLength": 8,
          "maxLength": 200,
          "description": "Required unique opaque ID for this intended analysis. Reuse only when retrying the same call; use a new value for an intentional rerun."
        }
      },
      "required": [
        "url",
    ...
    "inputSchema": {
      ...
      "properties": {
        "jobId": {
          "type": "string",
          "minLength": 1,
          "description": "The jobId returned by extract_site, analyze_site_similarity, or audit_site. Poll until status is complete, partial, or failed; partial jobs still return successful content and failure details."
        }
      },
      "required": [
        "jobId"
  ...
  },
  {
    ...
    "description": "Enrich 1–250 mapped business or person rows, supplied inline or by leadListId, with matched public website, phone, email, social, contact-form, and optional associated-person evidence. Use when the list already exists; to inspect a file first use lead_list_import, to discover businesses from a niche plus city use workflow_run with get-leads, and for candidate-only Maps discovery use maps_search. Starts an owner-scoped durable Task, bills underlying Maps/page/SERP attempts with unused hold refunded, and retains requested CSV/XLSX results seven days. Opt-in email snippet recovery costs at most one SERP search per unresolved row. For peopleDiscovery, author one-to-three focused peopleQueryTemplates with one role intent per query; each role query reads AI Overview plus organic results, then at most maxPeoplePerLead company-matched LinkedIn result searches run without opening LinkedIn pages. Public email occurrence is not deliverability or consent verification and is not permission to contact. A public role or LinkedIn occurrence is not verified current employment. Reuse idempotencyKey only to retry the same intended job.",
    "inputSchema": {
      "type": "object",
      "properties": {
        "idempotencyKey": {
          ...
          "minLength": 8,
          "maxLength": 200,
          "description": "Required stable key for this intended enrichment job. Reuse it only to retry the same job after a lost response."
        },
        "source": {
          "oneOf": [
            {
              ...
              "properties": {
                "kind": {
                  "type": "string",
                  "const": "rows",
                  "description": "Use rows when the supplied leads are already mapped scalar records."
                },
                "rows": {
                  "minItems": 1,
                  "maxItems": 250,
                  ...
                  "description": "One to 250 already-mapped scalar-valued lead records."
                }
              },
              "required": [
                "kind",
            ...
            },
            {
              ...
              "properties": {
                "kind": {
                  "type": "string",
                  "const": "lead_list",
                  "description": "Use lead_list for a normalized import returned by lead_list_import."
                },
                "leadListId": {
                  "type": "string",
                  "minLength": 1,
                  "description": "Opaque owner-scoped leadListId returned by lead_list_import and retained for seven days."
                }
              },
              "required": [
                "kind",
          ...
          "description": "Exactly one source: mapped inline rows or an imported leadListId."
        },
        "columnMap": {
          "type": "object",
          "properties": {
            "name": {
              "type": "string",
              "minLength": 1,
              "description": "Exact source header containing the business or person name."
            },
            "location": {
              "description": "Exact source header containing a combined city, region, or service-area value.",
              "type": "string",
              "minLength": 1
            },
            "city": {
              "description": "Exact source header containing the city or locality.",
              "type": "string",
              "minLength": 1
            },
            "region": {
              "description": "Exact source header containing the state, province, or region.",
              "type": "string",
              "minLength": 1
            },
            "organization": {
              "description": "Exact source header containing the company, brokerage, office, or team used to corroborate identity.",
              "type": "string",
              "minLength": 1
            },
            "websiteUrl": {
              "description": "Exact source header containing a public HTTP(S) website URL.",
              "type": "string",
              "minLength": 1
            },
            "profileUrl": {
              "description": "Exact source header containing a named person or team public profile URL.",
              "type": "string",
              "minLength": 1
            },
            "phone": {
              "description": "Exact source header containing an existing phone number used as identity evidence.",
              "type": "string",
              "minLength": 1
            },
            "entityType": {
              "description": "Exact source header whose values are business or person. Omit to use defaultEntityType.",
              "type": "string",
              "minLength": 1
            }
          },
          ...
          "additionalProperties": false,
          "description": "Exact source-header mapping. name is required; every mapped header must exist."
        },
        "defaultEntityType": {
          "default": "business",
          "description": "Entity type for rows without an entityType-mapped value.",
          "type": "string",
          "enum": [
            "business",
            "person"
        ...
        "resolveMissingUrls": {
          "default": true,
          "description": "When true, rows without supplied URLs may spend one exact-name Maps search. False restricts work to provided URLs.",
          "type": "boolean"
        },
        "gl": {
          "default": "us",
          "description": "Two-letter Google country code used only for missing-URL Maps resolution.",
          "type": "string",
          "minLength": 2,
          "maxLength": 2
        },
        "hl": {
          "default": "en",
          "description": "Two-letter Google language code used only for missing-URL Maps resolution.",
          "type": "string",
          "minLength": 2,
          "maxLength": 2
        },
        "maxPagesPerLead": {
          "default": 3,
          "description": "Maximum public page extraction attempts per row, including its starting page.",
          "type": "integer",
          "minimum": 1,
          "maximum": 4
        },
        "emailSearchFallback": {
          "default": "off",
          "description": "Optional recovery after bounded page extraction finds no email. serp_snippets spends at most one current-rate SERP search per unresolved row and accepts only exact-domain email occurrences from result titles/snippets. These public occurrences do not verify deliverability or consent.",
          "type": "string",
          "enum": [
            "off",
            "serp_snippets"
        ...
        "peopleQueryTemplates": {
          "description": "Ordered query templates the calling model should author when peopleDiscovery is enabled: use one role intent per template and the placeholders {business}, {city}, {region}, or {location}, for example {business} owner of company; one focused server fallback is used when omitted.",
          "minItems": 1,
          "maxItems": 3,
          "type": "array",
          "items": {
        ...
        "maxPeoplePerLead": {
          "default": 2,
          "description": "Maximum associated people retained and LinkedIn-searched per business row when peopleDiscovery is enabled; maximum added SERP cost is peopleQueryTemplates length (or one fallback) plus one profile search per retained person.",
          "type": "integer",
          "minimum": 1,
          "maximum": 3
        },
        "concurrency": {
          "default": 3,
          "description": "Maximum rows enriched concurrently. Default 3; maximum 5.",
          "type": "integer",
          "minimum": 1,
          "maximum": 5
        },
        "outputFormats": {
          ...
          "description": "Unique requested result formats. Defaults to both CSV and XLSX; this changes rendering only.",
          "minItems": 1,
          "maxItems": 2,
          "type": "array",
          "items": {
  ...
  },
  {
    ...
    "category": "leads",
    "title": "Lead List Enrichment Status",
    "description": "Check a job returned by lead_list_enrich. Returns bounded progress and samples while running, then settled billing, warnings, and renewed owner-scoped CSV/XLSX resources when terminal. Use only a returned jobId; missing, expired, and foreign-owner IDs are reported as not found.",
    "inputSchema": {
      "type": "object",
      "properties": {
        "jobId": {
          "type": "string",
          "minLength": 1,
          "description": "The jobId returned by lead_list_enrich. Poll until status is complete, partial, empty, failed, or cancelled."
        }
      },
      "required": [
        "jobId"
  ...
  },
  {
    ...
    "description": "Inspect and normalize supplied rows, CSV text, or a completed lead_list_upload_start upload into an owner-scoped leadListId retained seven days. Use before enrichment when sheet names, headers, or column mapping need inspection; for already-mapped rows call lead_list_enrich directly. Returns bounded samples and mapping suggestions, performs no web lookup, and spends no Maps/page credits. XLSX formulas are never executed and workbook styling/macros are not preserved. Reuse idempotencyKey only to retry the same import.",
    "inputSchema": {
      "type": "object",
      "properties": {
        "idempotencyKey": {
          ...
          "minLength": 8,
          "maxLength": 200,
          "description": "Required stable key for this intended import. Reuse it only to retry the same import with identical source and options."
        },
        "source": {
          "oneOf": [
            {
              ...
              "properties": {
                "kind": {
                  "type": "string",
                  "const": "rows",
                  "description": "Use rows when the host can express the supplied table as scalar records."
                },
                "rows": {
                  "minItems": 1,
                  "maxItems": 250,
                  ...
                  "description": "One to 250 scalar-valued source records. Original keys and values are preserved."
                }
              },
              "required": [
                "kind",
            ...
            },
            {
              ...
              "properties": {
                "kind": {
                  "type": "string",
                  "const": "csv_text",
                  "description": "Use csv_text when the host can provide bounded CSV or TSV text."
                },
                "csvText": {
                  "type": "string",
                  "minLength": 1,
                  "maxLength": 512000,
                  "description": "UTF-8 CSV or TSV text, at most 500 KiB. It is inspected and normalized before any enrichment."
                },
                "delimiter": {
                  "description": "Explicit comma or tab delimiter. Omit for deterministic comma-versus-tab detection.",
                  "type": "string",
                  "enum": [
                    ",",
                    "\t"
            ...
            },
            {
              ...
              "properties": {
                "kind": {
                  "type": "string",
                  "const": "upload",
                  "description": "Use upload after completing the signed PUT returned by lead_list_upload_start."
                },
                "uploadId": {
                  "type": "string",
                  "minLength": 1,
                  "description": "Opaque uploadId returned by lead_list_upload_start after the file PUT completed."
                },
                "sheetName": {
                  "description": "Exact XLSX sheet name to import. Supply after sheet_selection_required; do not use for CSV or TSV.",
                  "type": "string",
                  "minLength": 1
                }
              },
          ...
          "description": "Exactly one bounded source: rows, CSV/TSV text, or a completed private upload."
        }
      },
      "required": [
        "idempotencyKey",
  ...
  },
  {
    ...
    "category": "leads",
    "title": "Upload a Lead List",
    "description": "Create a one-file private upload for a CSV, TSV, or XLSX list when attachment bytes cannot be supplied as rows or CSV text. Do not use for pasted rows; call lead_list_enrich directly, or lead_list_import when the user supplied CSV text. Returns a signed PUT and a human upload page valid for 15 minutes; incomplete sessions expire after 24 hours. The upload stores input only and does not scrape, enrich, or spend Maps/page credits. Reuse idempotencyKey only to retry the same intended upload.",
    "inputSchema": {
      "type": "object",
      "properties": {
        "idempotencyKey": {
          ...
          "minLength": 8,
          "maxLength": 200,
          "description": "Required stable key for this intended upload session. Reuse it only to retry the same upload-start call."
        },
        "filenameHint": {
          "description": "Optional display-only filename. It does not determine or authorize the uploaded format.",
          "type": "string",
          "minLength": 1,
          "maxLength": 255
        }
    ...
    "inputSchema": {
      ...
      "properties": {
        "jobId": {
          "type": "string",
          "minLength": 1,
          "description": "Site export job ID returned by extract_site, analyze_site_similarity, or audit_site."
        },
        "imageId": {
          "type": "string",
          "pattern": "^[a-f0-9]{64}$",
