...
`client.tools` is the generated, typed 160-tool MCP surface. It includes 73 MCP Scraper tools and all 87 mirrored memory tools from `contracts/mcp.tools.json`.
