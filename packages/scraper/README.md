...
`client.tools` is the generated, typed 373-tool MCP surface from `contracts/mcp.tools.json`, including governed X-Ray revenue, survey, attribution-impact, and evidence-status operations.
