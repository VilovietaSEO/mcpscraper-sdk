...
`client.tools` is the generated, typed 249-tool MCP surface. It includes 148 MCP Scraper tools and all 101 mirrored Memory tools from `contracts/mcp.tools.json`.
