...
`client.tools` is the generated, typed 163-tool MCP surface. It includes 76 MCP Scraper tools and all 87 mirrored memory tools from `contracts/mcp.tools.json`.
