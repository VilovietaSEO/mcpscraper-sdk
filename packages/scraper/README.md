...
`client.tools` is the generated, typed 165-tool MCP surface. It includes 76 MCP Scraper tools and all 89 mirrored memory tools from `contracts/mcp.tools.json`.
