...
class AnalyticsTestCrmProvisioningInput(BaseModel):
    ...
    receipt: dict[str, Any] = Field(..., alias="receipt", description="Exact durable approval receipt returned by analytics_approve_crm_provisioning; altered receipts are rejected.")
