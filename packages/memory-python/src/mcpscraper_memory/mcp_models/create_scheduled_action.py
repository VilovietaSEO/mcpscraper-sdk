...
class CreateScheduledActionInput(BaseModel):
    ...
    artifact_selection: Any | None = Field(None, alias="artifactSelection", description="Presentation artifact selection. \"none\" means no HTML artifact; it does not disable writing the scheduled result to Memory. A saved_template selection pins one exact immutable template version.")
