...
class AssistantApprovalsListInput(BaseModel):
    ...
    state: Literal['pending', 'approved', 'rejected', 'expired', 'cancelled'] | None = (
        Field(
            None,
...
class Item(BaseModel):
    ...
    audience_digest: AudienceDigest | None = Field(..., alias='audienceDigest')
    spend_limit: SpendLimit | None = Field(..., alias='spendLimit')
...
class AssistantApprovalsListOutput1(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
        populate_by_name=True,
    )
...
class AssistantApprovalsListOutput2(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
        populate_by_name=True,
    )
...
class AssistantApprovalsListOutput3(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
        populate_by_name=True,
    )
...
class AssistantApprovalsListOutput(
    RootModel[
        AssistantApprovalsListOutput1
        | AssistantApprovalsListOutput2
        | AssistantApprovalsListOutput3
    ]
):
    root: (
        AssistantApprovalsListOutput1
...
class AssistantApprovalsListModels(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
        populate_by_name=True,
    )
    input: AssistantApprovalsListInput
    output: AssistantApprovalsListOutput
