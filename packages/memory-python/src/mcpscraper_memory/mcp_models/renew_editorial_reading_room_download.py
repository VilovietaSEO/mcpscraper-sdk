...
class RenewEditorialReadingRoomDownloadInput(BaseModel):
    model_config = ConfigDict(populate_by_name=True, extra="allow")

    artifact_id: str = Field(..., alias="artifactId", description="Private artifactId returned by create_editorial_reading_room.")


class RenewEditorialReadingRoomDownloadOutput(BaseModel):
    model_config = ConfigDict(populate_by_name=True, extra="allow")
