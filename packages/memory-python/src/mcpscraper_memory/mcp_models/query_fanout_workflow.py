...
class QueryFanoutWorkflowOutput(BaseModel):
    ...
    cited_urls: list[dict[str, Any]] = Field(..., alias="cited_urls", description="Researched URLs cited in the final answer.")
    browsed_only: list[dict[str, Any]] = Field(..., alias="browsed_only", description="Researched URLs pulled but not cited.")
