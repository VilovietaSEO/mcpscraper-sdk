...
class AnalyticsStartCrmSyncInput(BaseModel):
    ...
    provider: Literal['hubspot', 'salesforce', 'highlevel', 'zoho', 'pipedrive', 'keap'] = Field(..., alias="provider", description="Supported CRM provider; tenant evidence may narrow this provider to webhook or manual mode.")
