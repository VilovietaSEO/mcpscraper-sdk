...
class AuditSiteInput(BaseModel):
    ...
    rotate_proxies: bool | None = Field(None, alias="rotateProxies", description="Use extra measures to get past sites that block normal crawling. Slower/pricier — use only when a site blocks normal crawling.")
