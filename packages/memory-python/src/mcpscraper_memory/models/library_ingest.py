...
class LibraryIngestInput(BaseModel):
    ...
    vault: str | None = Field(None, alias="vault", description="Vault to deposit into. Optional; defaults to the session active vault, then the first entitled vault, then \"Library\".")
