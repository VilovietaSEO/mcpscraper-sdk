...
class GetScheduleStatusOutput(BaseModel):
    ...
    billing_mode: Literal["credits"] | None = Field(None, alias="billingMode", description="")
    ...
    default_timezone: str | None = Field(None, alias="defaultTimezone", description="IANA timezone applied to new schedules that name a time without a zone; null means UTC.")
