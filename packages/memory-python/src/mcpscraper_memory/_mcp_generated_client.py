...
from .mcp_models.maps_place_resume import MapsPlaceResumeInput, MapsPlaceResumeOutput
from .mcp_models.maps_place_status import MapsPlaceStatusInput, MapsPlaceStatusOutput
...
from .mcp_models.tiktok_video_transcribe import TiktokVideoTranscribeInput, TiktokVideoTranscribeOutput
...
class OtherNamespace:
    ...
    def tiktok_video_transcribe(self, **kwargs: Any) -> TiktokVideoTranscribeOutput:
        payload = TiktokVideoTranscribeInput(**kwargs).model_dump(by_alias=True, exclude_none=True)
        result = self._call_tool("tiktok_video_transcribe", payload)
        return TiktokVideoTranscribeOutput.model_validate(result)
...
class MapsNamespace:
    ...
    def place_resume(self, **kwargs: Any) -> MapsPlaceResumeOutput:
        payload = MapsPlaceResumeInput(**kwargs).model_dump(by_alias=True, exclude_none=True)
        result = self._call_tool("maps_place_resume", payload)
        return MapsPlaceResumeOutput.model_validate(result)

    def place_status(self, **kwargs: Any) -> MapsPlaceStatusOutput:
        payload = MapsPlaceStatusInput(**kwargs).model_dump(by_alias=True, exclude_none=True)
        result = self._call_tool("maps_place_status", payload)
        return MapsPlaceStatusOutput.model_validate(result)
