...
Official Python clients for the unified 362-tool [mcpscraper.dev](https://mcpscraper.dev) MCP catalog.
The direct 143-tool Memory manifest remains checked for runtime compatibility.
...
Use the same key with `McpToolsClient` for all 362 unified scraper and Memory tools.
