...
Official Python clients for all 153 unified [mcpscraper.dev](https://mcpscraper.dev) MCP tools plus the direct 86-tool [memory.mcpscraper.dev](https://memory.mcpscraper.dev) API.
...
Use `McpToolsClient(api_key="sk_...")` for all 153 unified tools; it has the same 30 generated namespaces as every other SDK package.
