export interface Input {
  ...
  siteId: string;
  /**
   * Preregistered hypothesis, metric, audience, sample requirements, expiry, allocations, and allowlisted visual operations. One control variant must have no operations.
   */
  plan: {
    /**
