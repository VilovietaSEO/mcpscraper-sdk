export interface Input {
  /**
   * Opaque caller-owned conversation reference returned by assistant_status or another assistant read.
   */
  conversationRef: string;
  /**
   * Opaque message cursor returned by the preceding page; omit for the newest page.
   */
  cursor?: string;
  /**
   * Maximum messages to return in this bounded page.
   */
  pageSize?: number;
}
