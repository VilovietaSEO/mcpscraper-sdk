...
Official TypeScript/JavaScript clients for all 157 tools at [mcpscraper.dev](https://mcpscraper.dev) plus the direct 86-tool [memory.mcpscraper.dev](https://memory.mcpscraper.dev) API.
...
`MemoryClient` retains the direct 86-tool memory namespaces. `McpToolsClient` is generated from [`contracts/mcp.tools.json`](../../contracts/mcp.tools.json) and contains all 157 tools — 72 MCP Scraper tools plus 85 mirrored memory tools — across its generated namespaces.
