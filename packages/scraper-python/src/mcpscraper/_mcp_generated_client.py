...
class ConnectionsNamespace:
    ...
    def test_service_connection(self, **kwargs: Any) -> Any:
        payload = TestServiceConnectionInput(**kwargs).model_dump(by_alias=True, exclude_none=True)
        return self._call_tool("test_service_connection", payload)
    ...
    def export_search_console_table_data(self, **kwargs: Any) -> Any:
        payload = ExportSearchConsoleTableDataInput(**kwargs).model_dump(by_alias=True, exclude_none=True)
        return self._call_tool("export_search_console_table_data", payload)
