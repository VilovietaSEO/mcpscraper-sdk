...
from .mcp_models.assistant_delivery_test import AssistantDeliveryTestInput, AssistantDeliveryTestOutput
from .mcp_models.assistant_diagnostics_get import AssistantDiagnosticsGetInput, AssistantDiagnosticsGetOutput
...
class AssistantNamespace:
    ...
    def delivery_test(self, **kwargs: Any) -> AssistantDeliveryTestOutput:
        payload = AssistantDeliveryTestInput(**kwargs).model_dump(by_alias=True, exclude_none=True)
        result = self._call_tool("assistant_delivery_test", payload)
        return AssistantDeliveryTestOutput.model_validate(result)

    def diagnostics_get(self, **kwargs: Any) -> AssistantDiagnosticsGetOutput:
        payload = AssistantDiagnosticsGetInput(**kwargs).model_dump(by_alias=True, exclude_none=True)
        result = self._call_tool("assistant_diagnostics_get", payload)
        return AssistantDiagnosticsGetOutput.model_validate(result)
