...
class CommonsNamespace:
    ...
    def search_entities(self, **kwargs: Any) -> Any:
        payload = CommonsSearchEntitiesInput(**kwargs).model_dump(by_alias=True, exclude_none=True)
        return self._call_tool("commons_search_entities", payload)

    def get_entity(self, **kwargs: Any) -> Any:
        payload = CommonsGetEntityInput(**kwargs).model_dump(by_alias=True, exclude_none=True)
        return self._call_tool("commons_get_entity", payload)

    def list_needs_links(self, **kwargs: Any) -> Any:
        payload = CommonsListNeedsLinksInput(**kwargs).model_dump(by_alias=True, exclude_none=True)
        return self._call_tool("commons_list_needs_links", payload)

    def prepare_entity(self, **kwargs: Any) -> Any:
        payload = CommonsPrepareEntityInput(**kwargs).model_dump(by_alias=True, exclude_none=True)
        return self._call_tool("commons_prepare_entity", payload)

    def validate_entity(self, **kwargs: Any) -> Any:
        payload = CommonsValidateEntityInput(**kwargs).model_dump(by_alias=True, exclude_none=True)
        return self._call_tool("commons_validate_entity", payload)

    def submit_entity(self, **kwargs: Any) -> Any:
        payload = CommonsSubmitEntityInput(**kwargs).model_dump(by_alias=True, exclude_none=True)
        return self._call_tool("commons_submit_entity", payload)

    def get_entity_ledger(self, **kwargs: Any) -> Any:
        payload = CommonsGetEntityLedgerInput(**kwargs).model_dump(by_alias=True, exclude_none=True)
        return self._call_tool("commons_get_entity_ledger", payload)

    def save_filter(self, **kwargs: Any) -> Any:
        payload = CommonsSaveFilterInput(**kwargs).model_dump(by_alias=True, exclude_none=True)
        return self._call_tool("commons_save_filter", payload)

    def list_filters(self, **kwargs: Any) -> Any:
        payload = CommonsListFiltersInput(**kwargs).model_dump(by_alias=True, exclude_none=True)
        return self._call_tool("commons_list_filters", payload)
...
class DirectoryNamespace:
    ...
    def get_local_sourcebook_contract(self, **kwargs: Any) -> Any:
        payload = GetLocalSourcebookContractInput(**kwargs).model_dump(by_alias=True, exclude_none=True)
        return self._call_tool("get-local-sourcebook-contract", payload)

    def list_local_sourcebook_tags(self, **kwargs: Any) -> Any:
        payload = ListLocalSourcebookTagsInput(**kwargs).model_dump(by_alias=True, exclude_none=True)
        return self._call_tool("list-local-sourcebook-tags", payload)

    def resolve_local_sourcebook_tags(self, **kwargs: Any) -> Any:
        payload = ResolveLocalSourcebookTagsInput(**kwargs).model_dump(by_alias=True, exclude_none=True)
        return self._call_tool("resolve-local-sourcebook-tags", payload)

    def prepare_local_sourcebook_write(self, **kwargs: Any) -> Any:
        payload = PrepareLocalSourcebookWriteInput(**kwargs).model_dump(by_alias=True, exclude_none=True)
        return self._call_tool("prepare-local-sourcebook-write", payload)

    def validate_local_sourcebook_write(self, **kwargs: Any) -> Any:
        payload = ValidateLocalSourcebookWriteInput(**kwargs).model_dump(by_alias=True, exclude_none=True)
        return self._call_tool("validate-local-sourcebook-write", payload)

    def local_sourcebook_capture(self, **kwargs: Any) -> Any:
        payload = LocalSourcebookCaptureInput(**kwargs).model_dump(by_alias=True, exclude_none=True)
        return self._call_tool("local-sourcebook-capture", payload)

    def local_sourcebook_submission_status(self, **kwargs: Any) -> Any:
        payload = LocalSourcebookSubmissionStatusInput(**kwargs).model_dump(by_alias=True, exclude_none=True)
        return self._call_tool("local_sourcebook_submission_status", payload)

    def local_sourcebook_refresh(self, **kwargs: Any) -> Any:
        payload = LocalSourcebookRefreshInput(**kwargs).model_dump(by_alias=True, exclude_none=True)
        return self._call_tool("local_sourcebook_refresh", payload)
