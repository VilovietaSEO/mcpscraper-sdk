...
class AnalyticsListCrmCapabilitiesInput(BaseModel):
...
class AnalyticsListCrmCapabilitiesOutput(BaseModel):
    model_config = ConfigDict(populate_by_name=True, extra="allow")

    ok: bool = Field(..., alias="ok", description="")
    providers: list[dict[str, Any]] = Field(..., alias="providers", description="")
