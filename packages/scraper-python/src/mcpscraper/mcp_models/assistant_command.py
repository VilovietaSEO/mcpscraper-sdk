...
class ContextPacketRef(RootModel[str]):
...
class AssistantCommandInput(BaseModel):
    ...
    context_packet_refs: list[ContextPacketRef] | None = Field(
        [],
        alias='contextPacketRefs',
...
class AssistantCommandOutput2(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
        populate_by_name=True,
    )
...
class AssistantCommandOutput3(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
        populate_by_name=True,
    )
...
class AssistantCommandOutput1(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
        populate_by_name=True,
    )
...
class AssistantCommandOutput(
    RootModel[
        AssistantCommandOutput1 | AssistantCommandOutput2 | AssistantCommandOutput3
    ]
):
    root: AssistantCommandOutput1 | AssistantCommandOutput2 | AssistantCommandOutput3


class AssistantCommandModels(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
        populate_by_name=True,
    )
    input: AssistantCommandInput
    output: AssistantCommandOutput
