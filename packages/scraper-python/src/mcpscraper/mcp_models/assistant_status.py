...
class Data(BaseModel):
    ...
    state: Literal['active', 'paused', 'deleting', 'deleted']
    display_name: str = Field(..., alias='displayName', max_length=160, min_length=1)
...
class AssistantStatusOutput1(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
        populate_by_name=True,
    )
...
class AssistantStatusOutput2(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
        populate_by_name=True,
    )
...
class AssistantStatusOutput3(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
        populate_by_name=True,
    )
...
class AssistantStatusOutput(
    RootModel[AssistantStatusOutput1 | AssistantStatusOutput2 | AssistantStatusOutput3]
):
    root: AssistantStatusOutput1 | AssistantStatusOutput2 | AssistantStatusOutput3


class AssistantStatusModels(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
        populate_by_name=True,
    )
    input: AssistantStatusInput
    output: AssistantStatusOutput
