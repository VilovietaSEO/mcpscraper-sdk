...
class AnalyticsGetFunnelInput(BaseModel):
    ...
    funnel_id: str = Field(..., alias="funnelId", description="Funnel definition id returned by analytics_list_funnels.")
    limit: int | None = Field(None, alias="limit", description="Maximum drill-down rows.")
    cursor: str | None = Field(None, alias="cursor", description="Opaque pagination cursor.")


class AnalyticsGetFunnelOutput(BaseModel):
    model_config = ConfigDict(populate_by_name=True, extra="allow")
